                        ...
                        <div class="card__container">
                            ...
                            <div class="card__action">
                                ...
                                <button
                                    ...
                                    @click="$router.push(`/portafolio/${item.id}`)"
                                >Detalle</button>
                            </div>
                        </div>
                    </div> -->
